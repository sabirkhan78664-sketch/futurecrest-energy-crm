    ...
    <div className="space-y-5 pb-8">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <form className="grid gap-3 lg:grid-cols-[2fr_1fr_1fr_1fr_auto]" method="get">
          ...
          <select name="status" defaultValue={params.status || ""} className="rounded-lg border border-slate-300 px-4 py-3"><option value="">All Status</option><option value="follow-up">Follow-up</option><option value="interested">Interested</option><option value="processing">Processing</option><option value="sold">Sold</option><option value="lost">Lost</option><option value="no answer">No Answer</option><option value="internal dnc">Internal DNC</option><option value="ngtg">NGTG</option><option value="rejected">Rejected</option></select>
